...
export default function RegistrationModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center sm:items-center sm:p-4">
      ...
      >
        <div className="shrink-0 border-b border-gray-100 px-4 pb-3 pt-3 sm:px-6 sm:pb-4 sm:pt-4">
          <div className="mx-auto mb-3 h-1 w-10 rounded-full bg-gray-300 sm:hidden" />
          <div className="flex items-center justify-between gap-3">
            <h2 id="registration-modal-title" className="text-lg font-extrabold text-primary-dark">
              Đăng ký tư vấn AI57
            </h2>
            <button
              type="button"
          ...
          <p className="mt-1 text-sm text-gray-500">
            Để lại thông tin, đội ngũ tư vấn sẽ liên hệ trong vòng 24h.
          </p>
        </div>

        <div className="overflow-y-auto overscroll-contain px-4 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-2 sm:px-6 sm:pb-8">
          <RegistrationForm inModal />
        </div>
      </div>
    </div>
  )
